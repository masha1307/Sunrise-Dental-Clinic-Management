...
<head>
    ...
    <title>Appointment Management - Dental Care System</title>
    ...
    <div class="form-card">
        ...
        <form action="${pageContext.request.contextPath}/appointment" method="post">
            <div class="form-grid">
                ...
                <div id="newPatientForm" style="display: none; margin-top: 20px; padding: 20px; background: #f8fafc; border-radius: 8px; border: 1px solid #e2e8f0;">
...
function togglePatientForm() {
    ...
    if (patientSelect.value === "new") {
        ...
        // Make new patient fields required when adding new patient
        ...
        // Remove required attribute when not adding new patient
